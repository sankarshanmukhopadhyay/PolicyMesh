...
TITLE = "Personal Shopping Agent Demo"
def main():
    parser=argparse.ArgumentParser(description="Run the PolicyMesh personal shopping agent reference example")
    parser.add_argument("scenario", nargs="?", default="permitted-purchase", choices=SCENARIOS+["all"])
